...
import 'package:movie_app_tmdb_flutter/providers/movie_provider.dart';
                ...
                return Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      data.apiPath == Api.popularMovie
                          ? Expanded(
                              child: Container(
                                child: data.movies.isEmpty
                                    ? Center(
                                        child: CircularProgressIndicator(
                                          color: Colors.purple,
                                        ),
                                      )
                                    : data.movies[0].title == 'no-data'
                                        ? Container(
                                            child: Column(
                                              mainAxisAlignment:
                                        ...
                                        : NotificationListener(
                                            onNotification: (onNotification) {
                                              if (onNotification
                                                ...
                                                final before = onNotification
                                                    .metrics.extentBefore;
                                                final max = onNotification
